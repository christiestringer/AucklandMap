...
public abstract class GUI {
	...
	/**
	 * Is a called whenever the route button is called. A user must click a position first
	 * call this button and then another position a route will be created between the two
	 * positions
	 */
	protected abstract void onRoute();
	
	/**
	 * Is a called whenever the articulation points button is called. The articulations button should 
	 * ask to click and position on the map and articulation points will be found.
	 */
